  ...
  return (
    ...
    >
      <g opacity={ICON_MUTED_LAYER_OPACITY} stroke="currentColor">
        <path d="M7 4V2.5" strokeLinecap="round" strokeWidth="1.5" />
        <path d="M17 4V2.5" strokeLinecap="round" strokeWidth="1.5" />
        <path d="M2.5 9H21.5" strokeLinecap="round" strokeWidth="1.5" />
      </g>
