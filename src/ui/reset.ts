 ...
 *  - Блочное отображение для мультимедиа (`<img>`, `<picture>`, `<video>`, `<canvas>`, `<svg>`)
 *  - Наследование шрифта и цвета для форм
 *  - Стили для кнопок (убраны дефолтные бордеры и фон)
 *  - Состояния `disabled` (прозрачность и курсор)
 ...
 *
 * Потребители: `src/context/theme/index.tsx` (`ThemeProvider`), один раз на приложение.
 */
 ...
 *
 * Подключается один раз в ThemeProvider (`src/context/theme/index.tsx`):
